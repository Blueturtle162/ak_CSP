...
print ("Camping is %s. You might see %s and a %s. The food which is cooked over the",word_4,"is very",word_5,". The best part of camping is using the",word_6,"which is very",word_7,". At night the tent is extremely",word_8,". It's always best to take a",word_9,"camping with you.")
*/
#include <stdio.h>
#include <string.h>
int main(void){
